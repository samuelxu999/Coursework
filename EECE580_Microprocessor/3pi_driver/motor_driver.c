...
void speedup_right_motor_forward(uint8_t duty_cycle_u8)
{	
	//startup from 0
	set_right_motor_duty_cycle(0x00);
	engage_right_motor_forward();
	while(get_right_motor_duty_cycle()<duty_cycle_u8)
	{
		set_right_motor_duty_cycle(get_right_motor_duty_cycle()+1);		
		_delay_ms(10);
	}
